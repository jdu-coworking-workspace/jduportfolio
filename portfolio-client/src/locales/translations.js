...
<li>Being involved with anti-social forces, providing benefits to or using such forces, or maintaining inappropriate relationships with them, or engaging in acts likely to lead to such outcomes</li>
		...
		ms_periodic_email: 'Update Reminder Periodic Email',
		ms_inactive_student_email: 'Inactive Student Email',
		ms_periodic_email_settings: 'Update Reminder Periodic Email Settings',
		...
		ms_inactive_description: 'Search for students whose profile is not public and who have not submitted a profile update within the selected period, then send them a notification email.',
		ms_inactive_period_title: 'Inactive Students (Period-based)',
		ms_1_week: '1 week',
		ms_2_weeks: '2 weeks',
		ms_3_weeks: '3 weeks',
		ms_4_weeks: '4 weeks',
...
<li>反社会的勢力等に関連する組織に属する行為、反社会的勢力に利益を与え、または利用する等不適切な関係を持つ行為、もしくはそれらのおそれのある行為</li>
		...
		// Mail Service
		ms_title: 'メールサービス',
		ms_periodic_email: '更新催促定期メール',
		ms_inactive_student_email: '未更新学生メール',
		ms_periodic_email_settings: '更新催促定期メール設定',
		ms_send_period: '送信間隔',
		ms_search_period: '検索期間',
		ms_email_subject: 'メール件名',
		ms_email_body: 'メール本文',
		ms_plain_text_hint: 'プレーンテキストで入力してください。改行は保持されます。',
		ms_inactive_description: 'プロフィールが非公開で、選択した期間内にプロフィール更新を提出していない学生を検索し、通知メールを送信します。',
		ms_inactive_period_title: '非活動学生（期間指定）',
		ms_1_week: '1週間',
		ms_2_weeks: '2週間',
		ms_3_weeks: '3週間',
		ms_4_weeks: '4週間',
...
<li>Antisotsial kuchlar bilan bog‘liq tashkilotlarga mansub bo‘lish, antisotsial kuchlarga foyda keltirish yoki ulardan foydalanish kabi nojo‘ya munosabatlarga ega bo‘lish xatti-harakati yoki bunga olib kelishi mumkin bo‘lgan xatti-harakatlar</li>
		...
		ms_periodic_email: 'Yangilanish eslatmasi davriy xat',
		ms_inactive_student_email: 'Nofaol talabalar xati',
		ms_periodic_email_settings: 'Yangilanish eslatmasi davriy xat sozlamalari',
		...
		ms_inactive_description: "Profili ommaviy bo'lmagan va tanlangan davr ichida profil yangilanishini topshirmagan talabalarni qidiring, so'ngra ularga bildirishnoma xatini yuboring.",
		ms_inactive_period_title: "Nofaol talabalar (davr bo'yicha)",
		ms_1_week: '1 hafta',
		ms_2_weeks: '2 hafta',
		ms_3_weeks: '3 hafta',
		ms_4_weeks: '4 hafta',
	...
	ru: {
		...
		ms_periodic_email: 'Периодическая рассылка напоминаний об обновлении',
		ms_inactive_student_email: 'Неактивные студенты',
		ms_periodic_email_settings: 'Настройки периодической рассылки напоминаний',
		...
		ms_inactive_description: 'Поиск студентов, чей профиль не публичен и которые не отправляли обновление профиля за выбранный период, затем отправка им уведомления по почте.',
		ms_inactive_period_title: 'Неактивные студенты (по периоду)',
		ms_1_week: '1 неделя',
		ms_2_weeks: '2 недели',
		ms_3_weeks: '3 недели',
		ms_4_weeks: '4 недели',
