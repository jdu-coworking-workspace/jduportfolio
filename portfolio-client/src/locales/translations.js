...
<li>Being involved with anti-social forces, providing benefits to or using such forces, or maintaining inappropriate relationships with them, or engaging in acts likely to lead to such outcomes</li>
		...
		ms_inactive_description: 'Search for students who were returned for resubmission and have not resubmitted within the selected period, then send them a reminder email.',
		ms_inactive_period_title: 'Returned Students (Period-based)',
		ms_1_week: '1 week',
		ms_2_weeks: '2 weeks',
		ms_3_weeks: '3 weeks',
		ms_4_weeks: '4 weeks',
...
<li>反社会的勢力等に関連する組織に属する行為、反社会的勢力に利益を与え、または利用する等不適切な関係を持つ行為、もしくはそれらのおそれのある行為</li>
		...
		ms_inactive_description: '差し戻し後、選択した期間内に再提出していない学生を検索し、リマインドメールを送信します。',
		ms_inactive_period_title: '差し戻し学生（期間指定）',
		ms_1_week: '1週間',
		ms_2_weeks: '2週間',
		ms_3_weeks: '3週間',
		ms_4_weeks: '4週間',
...
<li>Antisotsial kuchlar bilan bog‘liq tashkilotlarga mansub bo‘lish, antisotsial kuchlarga foyda keltirish yoki ulardan foydalanish kabi nojo‘ya munosabatlarga ega bo‘lish xatti-harakati yoki bunga olib kelishi mumkin bo‘lgan xatti-harakatlar</li>
		...
		ms_inactive_description: "Qayta topshirish uchun qaytarilgan va tanlangan davr ichida qayta topshirmagan talabalarni qidiring, so'ng ularga eslatma xatini yuboring.",
		ms_inactive_period_title: "Qaytarilgan talabalar (davr bo'yicha)",
		ms_1_week: '1 hafta',
		ms_2_weeks: '2 hafta',
		ms_3_weeks: '3 hafta',
		ms_4_weeks: '4 hafta',
	...
	ru: {
		...
		ms_inactive_description: 'Поиск студентов, которым вернули профиль на доработку и которые не отправляли повторно в выбранный период, затем отправка им письма-напоминания.',
		ms_inactive_period_title: 'Возвращенные студенты (по периоду)',
		ms_1_week: '1 неделя',
		ms_2_weeks: '2 недели',
		ms_3_weeks: '3 недели',
		ms_4_weeks: '4 недели',
